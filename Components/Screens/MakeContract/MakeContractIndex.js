...
export default class MakeContractIndex extends Component {
    constructor(props) {
        super(props);
        this.state = {
            type: "",
    ...
    render() {
        return (
            <View style={styles.container}>
                <Header title={'Nhập phụ lục hợp đồng'}/>
                <ScrollView>
                    <View style={styles.body}>
                                ...
                                <View style={{ paddingHorizontal: 10, paddingTop: 5, flexDirection: 'row' }}>
                                    ...
                                    <View style={{ flex: 3, flexDirection: 'row', alignItems: 'center' }}>
                                        <View
                                            ...
                                            style={styles.contextInputXCopy}
                        ...
                        <View style={[styles.totalRequest, { marginTop: 10, backgroundColor: '#005391' }]}>
                            <Text style={{ fontSize: 16, color: '#FFF' }}>Tổng Tiền</Text>
                            <Text style={{ fontSize: 18, color: '#FFF', fontWeight: 'bold' }}>66.123.000đ</Text>
                        </View>

                        <View style={[styles.totalRequest, { marginTop: 1, backgroundColor: '#005391',marginBottom:10 }]}>
                            <Text style={{ fontSize: 16, color: '#FFF' }}>Chuyển giao phụ lục</Text>
                            <Text style={{ fontSize: 18, color: '#FFF', fontWeight: 'bold' }}>66.123.000đ</Text>
                        </View>
