...
export default class MakeCost extends React.Component {
    ...
    componentDidMount(){
        this.setState({projectInfo:this.props.navigation.state.params.projectInfo})
        console.log('THong tin du an');
        console.log(this.props.navigation.state.params.projectInfo.data.projectTerms);
    }
    render() {
        return (
            <View style={styles.container}>
                ...
                <View>
                    <View style={{ padding: 10 }}>
                        ...
                        <FlatList
                        data={this.props.navigation.state.params.projectInfo.data.projectTerms}
                        renderItem={({item})=>
