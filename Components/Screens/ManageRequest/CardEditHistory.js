        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.body}>
                    ...
                    <View style={{flexDirection:'row',alignItems:'center',borderBottomWidth:1,marginHorizontal:10,paddingBottom:10}}>
                    ...
                    <View style={{borderBottomWidth:1,marginHorizontal:10,paddingBottom:10}}>
                    <Text style={{ fontSize: 16, color: 'black' }}>Chỉnh sửa tiêu đề phiếu
                    <Text style={{ fontSize: 16, color: '#005391' }}> Quyết toán chi phí CT 100 triệu 1 phút</Text>
                    </Text>
